...
export default function NavBar({ isDarkMode, toggleDarkMode }: NavBarProps) {
  return (
    <nav className="flex h-[38px] w-[327px] items-center justify-between md:w-[573px] desktop:w-[730px]">
      ...
      <div className="flex h-[20px] w-[78px] gap-[16px]">
        {isDarkMode ? (
          <p className="h-[19px] w-[40px] text-[13px] font-bold tracking-[2.5px] text-muted-blue dark:text-white">
            LIGHT
          </p>
        ) : (
          <p className="h-[19px] w-[40px] text-[13px] font-bold tracking-[2.5px] text-muted-blue">
            DARK
          </p>
        )}
        ...
        <button onClick={() => toggleDarkMode(!isDarkMode)}>
          {isDarkMode ? (
            ...
            <svg
              ...
              className="fill-[#FFF] duration-0 hover:fill-gray"
            >
              <g fill-rule="nonzero">
            ...
            <svg
              ...
              height="20"
              xmlns="http://www.w3.org/2000/svg"
              className="fill-[#697C9A] duration-0 hover:fill-black"
            >
              <path
