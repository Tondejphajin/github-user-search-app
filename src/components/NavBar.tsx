...
function SunIcon() {
  return (
    <svg
      ...
      className="size-[20px] fill-[#FFF] duration-0 hover:fill-muted-blue"
    >
      <path
        fill-rule="nonzero"
...
function MoonIcon() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="size-[20px] fill-[#697C9A] duration-0 hover:fill-black"
    >
      <path
...
export default function NavBar({ isDarkMode, toggleDarkMode }: NavBarProps) {
  return (
    <nav className="flex h-[38px] w-[327px] items-center justify-between md:w-[573px] desktop:w-[730px]">
      <div className="text-h1 font-bold desktop:text-[26px] dark:text-white">
        devfinder
      </div>
      <div
        className={`flex h-[20px] w-[78px] gap-[16px] ${isDarkMode ? "text-white" : "text-muted-blue"} hover:text-black dark:hover:text-muted-blue`}
      >
        <p
          className={`h-[19px] w-[40px] text-[13px] font-bold tracking-[2.5px] duration-0`}
        >
